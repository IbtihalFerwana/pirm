...
# Folders
IMAGE_DATA_FOLDER = '../../../genome_vision_data/data/GQA/allImages/images/' # replace with your path
# /home/shared/irm/genome_vision_data/data
# /data/GQA/allImages/images/
...
with open('dataset/meta_data/class_hierarchy.json') as f:
