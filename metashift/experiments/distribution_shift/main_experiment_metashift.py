...
# }
# DOMAINS_TO_GROUPS = {
#             0: {'cat':['cat_indoor_p0','cat_indoor_p1'],'dog':['dog_indoor_p0','dog_indoor_p1']},
#             1: {'cat':['cat_outdoor_p0','cat_outdoor_p1'],'dog':['dog_outdoor_p0','dog_outdoor_p1']},
# }
...
def main_generalization():
    ...
    parser.add_argument('--details',type=str,default='expa_a_irm')
    parser.add_argument('--irm_lambda',type=float,default=100)
    ...
    os.makedirs(args.results_file,exist_ok=True)
    ...
    ##################################
    my_dataset_manager = SubsetShiftDatasetManager(args,domains)
