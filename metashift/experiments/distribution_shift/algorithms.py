...
class IRM(ERM):
    ...
    def update(self, minibatches, unlabeled=None):
        ...
        penalty_weight = (self.hparams['irm_lambda'] if self.update_count
                          ...
                          1.0)
        # print("INSIDE UPDATE: ", self.hparams['irm_lambda'])
        nll = 0.
        penalty = 0.
        ...
        return {'loss': loss.item(), 'nll': nll.item(),
            'penalty': penalty.item(), 'count':self.update_count, 'penalty_weight * penalty':penalty_weight * penalty}
...
class IB_IRM(ERM):
    ...
    # print("\t\t in algorithms.py === IB_IRM started ===")
    def __init__(self, input_shape, num_classes, num_domains, hparams):
